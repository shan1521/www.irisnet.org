export const message = {
    ...
    presskitThree:{
        title:'Press Kit',
        secondTitle:'Get our press kit with all logo assets you might need',
        resources:'Resources',
        about:{
            AboutIRISnet:'About IRISnet',
            title:'IRISnet: Interchain Service Hub for NextGen Distributed Applications -- A BPoS Blockchain that is Self-evolutionary.',
    ...
    events:{
        ...
        eventsList : [
            ...
            },
            {
                ...
                month : 'Jul',
                day : '15',
                title : 'Online AMA in Korean Community',
    ...
    devPortal : {
        ...
        second : {
            title : 'How to use iService',
            content : 'IRIS Services (a.k.a. "iService") intend to bridge the gap between the blockchain world and the conventional business application world, by mediating a complete lifecycle of off-chain services -- from their definition, binding (provider registration), invocation, to their governance (profiling and dispute resolution). ',
            define : '1.Service Definition',
            bind : '2.Service Binding',
            call : '3.Service Invocation',
            more : 'View more',
            moreLink : 'https://www.irisnet.org/docs/features/service.html',
        },
        third : {
            title : 'Helpful tools',
            monitor : {
            ...
            management : {
                ...
                href : 'https://www.irisnet.org/docs/tools/kms.html',
            },
            support : {
        ...
        fourth : {
            ...
            advice : 'Contributions to the open-source project irishub mean many things, such as participating in discussions or proposing code changes.',
            reference : 'To ensure that all participants collaborate harmoniously, here is a general procedure of contributing for your reference.',
            detail : 'View more',
